...
기본은 오늘(로컬 자정~지금)이지만, `--since`로 시작 시점을 바꿀 수 있습니다. 상한은 항상 현재 시각입니다.

```console
$ jtic --since 2026-06-01   # 그 날 로컬 자정부터 (달력 경계)
$ jtic --since 7d           # 지난 7일 (롤링)
$ jtic --since 24h          # 지난 24시간 (롤링)
$ jtic --since 2w           # 지난 2주 (롤링)
```
